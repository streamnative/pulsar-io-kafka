...
CLI_LOG_FILE=${CLI_LOG_FILE:-"pulsar-io-kafka-json-producer.log"}
...
GC_OPTS=$(build_cli_jvm_opts ${CLI_LOG_DIR} "pulsar-io-kafka-json-producer.log")
...
cd "$PULSAR_IO_HOME"
exec ${JAVA} ${OPTS} io.streamnative.connectors.kafka.example.KafkaJsonProducerExample $@
