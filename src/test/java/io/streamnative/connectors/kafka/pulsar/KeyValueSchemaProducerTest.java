...
@Slf4j
public class KeyValueSchemaProducerTest extends PulsarProducerTestBase {

    public KeyValueSchemaProducerTest(PulsarService service) {
        super(service);
    }
    ...
    private <K, V> void testSendMessages(
        ...
        @Cleanup
        KeyValueSchemaProducer producer = new KeyValueSchemaProducer(
